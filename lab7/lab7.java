...
public class lab7{
 ...
 File file = new File("./EnglishSpanish.csv");
 int countlines =0;
 try {
 ...
 //this piece of code above is just to count how many lines there are
 //then we can create an array of that size and fill it with all the Strings
 ...
 //that takes in the input array, the start and end position,and the binary tree

 System.out.println("The resulting binary tree has "+mytree.height()+" levels");
 //print out the height of the tree and then read in the sentence to translate

 Scanner myscanner = new Scanner(System.in);
 System.out.println("Please enter your sentence: ");
 String[] words = myscanner.nextLine().toLowerCase().split("");
 //split the words by spaces and then lookup the translation for each
 ...
 //if there's no translation print out the original English version
 ...
 //the base case is when the start and end parameters meet each other
...
insertValue);
 ...
 //the height here is 1 higher than the biggest height of thetwo children
 return 1+ Math.max(leftHeight, rightHeight);
 } 


 //this lookup method is not recursive
 //it keeps looping until it finds the word or goes off the end of the tree
 //goes left or right depending on the whether the lookup word is bigger or smaller
